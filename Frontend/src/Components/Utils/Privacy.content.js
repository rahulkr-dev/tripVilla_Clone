...
If you wish, you can prevent cookie files from using (non-personal) information about you by either deleting the cookie folder in your browser or by putting your browser's Privacy setting higher, but doing so will mean that (a) your use of the Site will be adversely affected (and quite possibly entirely prevented), (b) your experience of this and other sites that use cookies to enhance or personalize your experience will be adversely affected, and (c) you will not be presented with advertising that reflects the way that you use our, and other, sites. You find out how to make these changes to your browser at this site: www.allaboutcookies.org/manage-cookies/.`

 const clearGif = `We gather and share anonymised information concerning the usage of the Site by members and travelers with one or more third-party tracking companies for the purpose of reporting statistics. In this connection, some of the pages you visit on our Site use electronic images placed in the web page code, called pixel tags (also called a "clear GIFs" or "Web Beacons") that can serve many of the same purposes as cookies.
...
The Site's third-party advertising service providers may also use Web Beacons to recognize you when you visit the Site and to help determine how you found the Site. If you would like more information about this practice and to know your choices about not having this information used by these companies, click here: http://networkadvertising.org/consumer/opt_out.asp.`
 ...
 const thirdParties  = `* As indicated above, we may work with other companies who place cookies or web beacons on our Site. These companies help operate our Site and provide you with additional products and services. They are subject to confidentiality agreements with us and other legal restrictions. We do not permit any of these companies to collect personal information using cookies or web beacons on our Site.`

 const changePrivacyPolicy  = `We reserve the right to change this Privacy Policy from time to time, and post the new version on the Site. In general the new privacy policies will come into effect:

commencing one month after the date of posting;
if earlier, when (following posting of the new Privacy Policy) you make an inquiry or otherwise interact with us or another user; or
immediately upon the date of posting, if the changes are not to operative provisions, or not capable of adversely affecting you - examples of which would include, without limitation, changes to contact details referred to, or the refinement of provisions that are already included, in this Privacy Policy.`

 const howLongKeepData = `We will retain your personal data only as long as is necessary for the purposes to which you consent under the Terms and Conditions and this Privacy Policy, or as is required by applicable law, and then we will delete it.`

 const disclosureLegal = `Your personal data may be disclosed if we or an entity processing your data on our behalf are compelled to do so by law, or receive a valid, legally compliant request by a law enforcement or governmental authority.`

const contactYou = `If you have any questions about this Privacy Policy, the practices of this Site, or your dealings with this Site, we encourage you to contact us by either emailing support@tripvillas.com or Snail mail on 261 Waterloo Street, #03-32, Singapore 180261. You can also visit any of our offices to speak to someone in person.`


export const privacyData = [
    {
        title:'Who processes your personal data?',
        data:ProcessPersonalData
    },
    {
    ...
    {
        title:'How Do We Protect Your Personal Information Once We Have It?',
        data:protectPersonalData
    },
    {
        title:'What is a Cookie and Why Do We Use Them?',
        data:whyCookie
    },
    {
        title:'Web Beacons and Clear GIFs',
        data:clearGif
    },
    {
        title:'How we protect your privacy with third parties',
        data:thirdParties
    },
    {
        title:'Changes to this Privacy Policy',
        data:changePrivacyPolicy
    },
    {
        title:'How long will we keep your personal data?',
        data:howLongKeepData
    },
    {
        title:'Disclosure for legal reasons',
        data:disclosureLegal
    },
    {
